<template>
  <div class="hud-bar">
    <div class="hud-left">
      <div class="stat-box">
        <span class="stat-label">{{ $t('game.scoreLabel') }}</span>
        <span class="stat-value score-value">{{ $t('game.score', { score }) }}</span>
      </div>
      <div class="stat-box">
        <span class="stat-label">{{ $t('game.hissesLabel') }}</span>
        <span class="stat-value">{{ $t('game.hisses', { count: hissCount }) }}</span>
      </div>
    </div>
    ...
    <div class="hud-right">
      <button class="help-btn" @pointerdown.prevent="speakRules" :class="{ speaking: isSpeaking }">
